...
public class Game extends JPanel {
    ...
    public void paint(Graphics g){
        ...
        try{
            g.drawImage(ImageIO.read(new File("src/board1.png")),50,0,750,765,null);
        }
        catch(Exception e){
            System.out.println(e);
        }
    ...
    class ClickListener implements ActionListener {
        public void actionPerformed(ActionEvent event){
            if (turn == 1){
                ...
                if(nextPosition == 37) nextPosition = 4;
                else if(nextPosition == 86) nextPosition = 54;
                else if(nextPosition == 46) nextPosition = 12;
                else if(nextPosition == 65) nextPosition = 38;
                else if(nextPosition == 29) nextPosition = 49;
                else if(nextPosition == 36) nextPosition = 54;
                else if(nextPosition == 63) nextPosition = 97;
