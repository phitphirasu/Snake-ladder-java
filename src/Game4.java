...
public class Game4 extends JPanel {
    ...
    public void paint(Graphics g){
        ...
        try{
            g.drawImage(ImageIO.read(new File("src/board4.png")),50,0,750,765,null);
        }
        catch(Exception e){
            System.out.println(e);
        }
    ...
    class ClickListener implements ActionListener {
        public void actionPerformed(ActionEvent event){
            if (turn == 1){
                ...
                if(nextPosition == 43) nextPosition = 1;
                else if(nextPosition == 36) nextPosition = 8;
                else if(nextPosition == 51) nextPosition = 27;
                else if(nextPosition == 97) nextPosition = 75;
                else if(nextPosition == 2) nextPosition = 42;
                else if(nextPosition == 37) nextPosition = 77;
                else if(nextPosition == 12) nextPosition = 52;
                else if(nextPosition == 54) nextPosition = 94;
