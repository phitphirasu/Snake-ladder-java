...
public class Game3 extends JPanel {
    ...
    public void paint(Graphics g){
        ...
        try{
            g.drawImage(ImageIO.read(new File("src/board3.png")),50,0,750,765,null);
        }
        catch(Exception e){
            System.out.println(e);
        }
    ...
    class ClickListener implements ActionListener {
        public void actionPerformed(ActionEvent event){
            if (turn == 1){
                ...
                else if(nextPosition == 64) nextPosition = 38;
                else if(nextPosition == 88) nextPosition = 55;
                else if(nextPosition == 96) nextPosition = 65;
                else if(nextPosition == 12) nextPosition = 34;
                else if(nextPosition == 25) nextPosition = 46;
